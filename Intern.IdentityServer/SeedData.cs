...
namespace Intern.IdentityServer
{
    public class SeedData
    {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            var angella = userMgr.FindByNameAsync("adrian").Result;
            if (angella == null)
            {
                ...
                result =
                    userMgr.AddClaimsAsync(
                        ...
                        new Claim[]
                        {
                            new Claim(JwtClaimTypes.Name, "adrian constantinache"),
                            new Claim(JwtClaimTypes.GivenName, "adrian"),
                            new Claim(JwtClaimTypes.FamilyName, "constantinache"),
                            new Claim(JwtClaimTypes.WebSite, "http://adrian.com"),
                            new Claim("location", "craiova")
                        }
                    ).Result;
                if (!result.Succeeded)
                {
